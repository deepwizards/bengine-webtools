...
exports.scrapeHTML = async (url) => {
	try {
        ...
        await page.setUserAgent('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.3'); // Set a common user agent
...
// Usage:
//
// scrapeHTMLWithRetries('example.com').then((data) => {
//     console.log(data);
// }).catch((error) => {
